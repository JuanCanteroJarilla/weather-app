...
const GeneralInfo = () => {
  const { weatherData, setCity, setWeatherData } = useWeatherStore() as {
  ...
  return (
    <aside className="w-[20vw] h-screen bg-white/5 backdrop-blur-md border border-white/20 px-4 text-black placeholder-black/70 shadow-lg">
